...
/*:
 We can decompose a tuple into individual values. Decomposing looks like this:
*/
...
/*:
 When you name the elements you effectively assign names to their indices, 
 so the dot operator still works with names or integers:
*/
